<template>
    <header class="header" :class="scrolled && 'header--fixed'">
		...
		c32.4,0,58.8-26.4,58.8-58.7H849.4z" />
            ...
            <transition name="fade">
                <nav class="header__header-menu" v-show="isLargeTablet() ? showMenu : true">
                    ...
                    <div class="header-menu__socials-wrap">
                        <div class="header-menu__socials-title">{{ t('follow') }}</div>
            ...
            <button class="header__menu-toggler" :class="showMenu && 'header__menu-toggler--expanded'"
    ...
    &__menu-toggler {
        ...
        &--expanded {
            span {
                ...
                &:last-of-type {
                    transform: translateZ(0) rotate(-45deg) translate(11px, -1px);
                }
            }
        }
    }
